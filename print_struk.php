    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-6 mx-auto" style="border: 1px solid #000;">
          <h4 class="text-center mt-2"><img src="../assets/image/logo.png" width="40" align="middle"><span class="mt-3">Rasa Banjar</span></h4>
          <hr>
          <div class="row mt-3">
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col text-center">
              <p>
                Terima Kasih <br> Atas Kunjungan Anda, Semoga harimu menyenangkan
              </p>
            </div>
          </div>
        </div>
